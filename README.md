...
Engineering Leader with 15+ years of experience designing and operating cloud platforms, internal developer portals, and multi-account AWS foundations for financial services. Based in Brazil, currently leading the platform engineering team at VrdeBank.
...
- **[Backstage Blueprint](https://github.com/henriquesgnc/backstage-blueprint)** — Internal Developer Portal blueprint with 7 production-ready software templates: repository scaffolding, Kubernetes (raw manifests + Helm), Docker build & push, AWS Lambda, Terraform modules, and TechDocs.
- **[Google Workspace User Management](https://github.com/henriquesgnc/google-workspace-user-management-apps-script)** — User lifecycle automation for Google Workspace: create and suspend users from Google Forms, manage group membership, send welcome emails, and calendar reminders via Apps Script and Admin SDK.
